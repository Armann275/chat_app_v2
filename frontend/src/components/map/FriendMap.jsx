...
function avatarIcon({ url, name, ring = 'ring-white' }) {
  ...
  return L.divIcon({
    ...
    html: `
      <div style="display:flex;flex-direction:column;align-items:center;">
        ...
        ${name ? `<span style="margin-top:2px;background:rgba(255,255,255,0.92);color:#1e293b;padding:1px 6px;border-radius:4px;font-size:10px;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,0.15);max-width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${escapeHtml(name)}</span>` : ''}
      </div>
    `,
  });
}
